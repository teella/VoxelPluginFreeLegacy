#include "GothGirl_FloatingIslandOnion.h"
...
class FGothGirl_FloatingIslandOnionInstance : public TVoxelGraphGeneratorInstanceHelper<FGothGirl_FloatingIslandOnionInstance, UGothGirl_FloatingIslandOnion>
{
public:
	struct FParams
	{
	...
	private:
		...
		void Function0_XYZWithCache_Compute(const FVoxelContext& Context, const FBufferX& BufferX, const FBufferXY& BufferXY, FOutputs& Outputs) const
		{
			...
			Variable_31 = FVoxelNodeFunctions::Abs(Variable_11);
	...
	private:
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContextRange& Context, FOutputs& Outputs) const
		{
			...
			Variable_26 = FVoxelNodeFunctions::Abs(Variable_9);
	...
	FGothGirl_FloatingIslandOnionInstance(UGothGirl_FloatingIslandOnion& Object)
...
template<>
inline v_flt FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalValue::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalValue::FOutputs::Set<v_flt, 1>(v_flt InValue)
{
	Value = InValue;
}
template<>
inline FVoxelMaterial FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Get<FVoxelMaterial, 2>() const
{
	return MaterialBuilder.Build();
}
template<>
inline void FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Set<FVoxelMaterial, 2>(FVoxelMaterial Material)
{
}
template<>
inline v_flt FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 3>() const
{
	return UpVectorX;
}
template<>
inline void FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 3>(v_flt InValue)
{
	UpVectorX = InValue;
}
template<>
inline v_flt FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 4>() const
{
	return UpVectorY;
}
template<>
inline void FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 4>(v_flt InValue)
{
	UpVectorY = InValue;
}
template<>
inline v_flt FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 5>() const
{
	return UpVectorZ;
}
template<>
inline void FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 5>(v_flt InValue)
{
	UpVectorZ = InValue;
}
template<>
inline TVoxelRange<v_flt> FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FGothGirl_FloatingIslandOnionInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Set<v_flt, 1>(TVoxelRange<v_flt> InValue)
{
	Value = InValue;
}
template<>
inline auto& FGothGirl_FloatingIslandOnionInstance::GetTarget<1>() const
{
	return LocalValue;
}
template<>
inline auto& FGothGirl_FloatingIslandOnionInstance::GetTarget<2>() const
{
	return LocalMaterial;
}
template<>
inline auto& FGothGirl_FloatingIslandOnionInstance::GetRangeTarget<0, 1>() const
{
	return LocalValueRangeAnalysis;
}
template<>
inline auto& FGothGirl_FloatingIslandOnionInstance::GetTarget<3, 4, 5>() const
{
...
UGothGirl_FloatingIslandOnion::UGothGirl_FloatingIslandOnion()
{
	bEnableRangeAnalysis = true;
}

TVoxelSharedRef<FVoxelTransformableGeneratorInstance> UGothGirl_FloatingIslandOnion::GetTransformableInstance()
{
#if VOXEL_GRAPH_GENERATED_VERSION == 1
	return MakeVoxelShared<FGothGirl_FloatingIslandOnionInstance>(*this);
#else
#if VOXEL_GRAPH_GENERATED_VERSION > 1
