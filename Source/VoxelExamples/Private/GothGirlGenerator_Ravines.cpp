#include "GothGirlGenerator_Ravines.h"

PRAGMA_GENERATED_VOXEL_GRAPH_START

using FVoxelGraphSeed = int32;

class FGothGirlGenerator_RavinesInstance : public TVoxelGraphGeneratorInstanceHelper<FGothGirlGenerator_RavinesInstance, UGothGirlGenerator_Ravines>
{
public:
	struct FParams
	{
	...
	private:
		...
		void Function0_XYZWithCache_Compute(const FVoxelContext& Context, const FBufferX& BufferX, const FBufferXY& BufferXY, FOutputs& Outputs) const
		{
			...
			// ------------------------------------------
			// Z
			v_flt GG_Z; // Z output 0
			GG_Z = Context.GetLocalZ();

			// Data Item Sample
			v_flt GG_DataItemSample; // Data Item Sample output 0
			GG_DataItemSample = FVoxelNodeFunctions::GetDataItemDistance(Context.Items.ItemHolder, BufferX.Variable_0, BufferXY.Variable_1, GG_Z, v_flt(5.0f), v_flt(1000.0f), 1u, EVoxelDataItemCombineMode::Min);
			
			// * -1
			v_flt GG_Negative; // * -1 output 0
			GG_Negative = GG_DataItemSample * -1;


			// Smooth Intersection
			v_flt GG_SmoothIntersection; // Smooth Intersection output 0
			GG_SmoothIntersection = FVoxelSDFNodeFunctions::SmoothIntersection(Variable_28, GG_Negative, v_flt(5.0f));

			// Set High Quality Value.*
			v_flt GG_HighQualityValue; // Set High Quality Value.* output 0
			GG_HighQualityValue = GG_SmoothIntersection * v_flt(0.2f);

			Outputs.Value = GG_HighQualityValue;
			// ------------------------------------------
		...
		void Function0_XYZWithoutCache_Compute(const FVoxelContext& Context, FOutputs& Outputs) const
		{
			...
			// Data Item Sample
			v_flt GG_DataItemSample; // Data Item Sample output 0
			GG_DataItemSample = FVoxelNodeFunctions::GetDataItemDistance(Context.Items.ItemHolder, Variable_0, Variable_1, GG_Z, v_flt(5.0f), v_flt(1000.0f), 1u, EVoxelDataItemCombineMode::Min);
	...
	FGothGirlGenerator_RavinesInstance(UGothGirlGenerator_Ravines& Object)
...
template<>
inline v_flt FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalValue::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalValue::FOutputs::Set<v_flt, 1>(v_flt InValue)
{
	Value = InValue;
}
template<>
inline FVoxelMaterial FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Get<FVoxelMaterial, 2>() const
{
	return MaterialBuilder.Build();
}
template<>
inline void FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Set<FVoxelMaterial, 2>(FVoxelMaterial Material)
{
}
template<>
inline v_flt FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 3>() const
{
	return UpVectorX;
}
template<>
inline void FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 3>(v_flt InValue)
{
	UpVectorX = InValue;
}
template<>
inline v_flt FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 4>() const
{
	return UpVectorY;
}
template<>
inline void FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 4>(v_flt InValue)
{
	UpVectorY = InValue;
}
template<>
inline v_flt FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 5>() const
{
	return UpVectorZ;
}
template<>
inline void FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 5>(v_flt InValue)
{
	UpVectorZ = InValue;
}
template<>
inline TVoxelRange<v_flt> FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FGothGirlGenerator_RavinesInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Set<v_flt, 1>(TVoxelRange<v_flt> InValue)
{
	Value = InValue;
}
template<>
inline auto& FGothGirlGenerator_RavinesInstance::GetTarget<1>() const
{
	return LocalValue;
}
template<>
inline auto& FGothGirlGenerator_RavinesInstance::GetTarget<2>() const
{
	return LocalMaterial;
}
template<>
inline auto& FGothGirlGenerator_RavinesInstance::GetRangeTarget<0, 1>() const
{
	return LocalValueRangeAnalysis;
}
template<>
inline auto& FGothGirlGenerator_RavinesInstance::GetTarget<3, 4, 5>() const
{
...
UGothGirlGenerator_Ravines::UGothGirlGenerator_Ravines()
{
	bEnableRangeAnalysis = true;
}

TVoxelSharedRef<FVoxelTransformableGeneratorInstance> UGothGirlGenerator_Ravines::GetTransformableInstance()
{
	return MakeVoxelShared<FGothGirlGenerator_RavinesInstance>(*this);
}
