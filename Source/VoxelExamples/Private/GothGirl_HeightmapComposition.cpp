#include "GothGirl_HeightmapComposition.h"
...
class FGothGirl_HeightmapCompositionInstance : public TVoxelGraphGeneratorInstanceHelper<FGothGirl_HeightmapCompositionInstance, UGothGirl_HeightmapComposition>
{
public:
	struct FParams
	{
	...
	FGothGirl_HeightmapCompositionInstance(UGothGirl_HeightmapComposition& Object)
...
template<>
inline v_flt FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalValue::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalValue::FOutputs::Set<v_flt, 1>(v_flt InValue)
{
	Value = InValue;
}
template<>
inline FVoxelMaterial FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Get<FVoxelMaterial, 2>() const
{
	return MaterialBuilder.Build();
}
template<>
inline void FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalMaterial::FOutputs::Set<FVoxelMaterial, 2>(FVoxelMaterial Material)
{
}
template<>
inline v_flt FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 3>() const
{
	return UpVectorX;
}
template<>
inline void FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 3>(v_flt InValue)
{
	UpVectorX = InValue;
}
template<>
inline v_flt FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 4>() const
{
	return UpVectorY;
}
template<>
inline void FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 4>(v_flt InValue)
{
	UpVectorY = InValue;
}
template<>
inline v_flt FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Get<v_flt, 5>() const
{
	return UpVectorZ;
}
template<>
inline void FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalUpVectorXUpVectorYUpVectorZ::FOutputs::Set<v_flt, 5>(v_flt InValue)
{
	UpVectorZ = InValue;
}
template<>
inline TVoxelRange<v_flt> FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Get<v_flt, 1>() const
{
	return Value;
}
template<>
inline void FGothGirl_HeightmapCompositionInstance::FLocalComputeStruct_LocalValueRangeAnalysis::FOutputs::Set<v_flt, 1>(TVoxelRange<v_flt> InValue)
{
	Value = InValue;
}
template<>
inline auto& FGothGirl_HeightmapCompositionInstance::GetTarget<1>() const
{
	return LocalValue;
}
template<>
inline auto& FGothGirl_HeightmapCompositionInstance::GetTarget<2>() const
{
	return LocalMaterial;
}
template<>
inline auto& FGothGirl_HeightmapCompositionInstance::GetRangeTarget<0, 1>() const
{
	return LocalValueRangeAnalysis;
}
template<>
inline auto& FGothGirl_HeightmapCompositionInstance::GetTarget<3, 4, 5>() const
{
...
UGothGirl_HeightmapComposition::UGothGirl_HeightmapComposition()
{
	bEnableRangeAnalysis = true;
}

TVoxelSharedRef<FVoxelTransformableGeneratorInstance> UGothGirl_HeightmapComposition::GetTransformableInstance()
{
#if VOXEL_GRAPH_GENERATED_VERSION == 1
	return MakeVoxelShared<FGothGirl_HeightmapCompositionInstance>(*this);
#else
#if VOXEL_GRAPH_GENERATED_VERSION > 1
